import DynamicalSystemsBranchesPhysicsQuantumFoundationCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "spectral theorem, uncertainty principle, commutation relations, state spaces under dynamical systems constraint",
